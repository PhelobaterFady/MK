...
export const userSchema = z.object({
  ...
  accountLevel: z.number().default(1),
  totalTrades: z.number().default(0),
  totalTransactionValue: z.number().default(0),
...
export const orderSchema = z.object({
  ...
  gameAccountTitle: z.string().optional(),
  accountDetails: z.string().optional(),
  status: z.enum(["pending", "escrow", "delivered", "completed", "disputed", "cancelled", "delivering", "awaiting_confirmation"]),
